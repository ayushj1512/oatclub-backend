...
const SELLER = {
  ...
  address:
    ...
    "Ground Floor KH NO- 36/7-A-117",

  addressLine2: process.env.INVOICE_SELLER_ADDRESS_LINE_2 || "RADHEY SHYAM PARK EXTN KHUREJI KHAS,",
  ...
  pincode: process.env.INVOICE_SELLER_PINCODE || "110051",
